...
SYSINCLUDES	= -I/usr/include -I$(BOOST_ROOT) -I$(PLATFORM_DIR)/include -I$(FFTW_UTIL)/include -I$(FFTWSYS)
SYSLIBS         = -L/usr/lib -L$(PLATFORM_DIR)/lib -L$(FFTW_UTIL)/lib -L$(FFTWSYS)
...
CXXFLAGS     += $(SYSINCLUDES) $(INC_ARA_UTIL)# -march=native -O3 
...
LIBS	= $(ROOTLIBS) -lMathMore -lMinuit $(SYSLIBS) -lsqlite3 -lfftw3 
GLIBS	= $(ROOTGLIBS) $(SYSLIBS) $(FFTWSYS)
